...
label start:
    play music "fon.mp3" volume 0.1
    $ renpy.music.queue("fon.mp3", loop=True)
    scene black
    ...
    show gala at left:
        ...
        ypos 0.9
    with dissolve
    play sound "grom.mp3" volume 1.0
...
label sex():
    ...
    scene black
    with fade
    narrator "Под жалкие стоны Никиты и удовлетворенные вопли Галины я завершу своё мини повествование о сегодняшнем дне..."
    play sound "ston.mp3"
    narrator "Нет повести печальнее на свете, чем повесть о Никите и минете..."
    pause 2.0
    return
#Буквы
#Эфеект молнии
